...
import 'user_data-rev.dart'; // developed file 
import 'installed-rev.dart'; // developed file 

// this section developed by Technical Lead (Will) and Project Lead (Delaney) 
  ...
  void initState() {
    ...
    specificToUser.forEach((element) {
      allMarkers.add(Marker(
          ...
          draggable: false,
          infoWindow:
              InfoWindow(title: element.name, snippet: element.location), // dispays basics about each marker 
...
// integrating both applicatin processes developed together
  // this section developed by Interface Lead, Emma. Assistance from Stephanie and Isabelle. 
