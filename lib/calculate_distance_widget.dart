...
class CalcDistanceWidget extends StatefulWidget {
  @override
  _CalcDistanceState createState() => _CalcDistanceState();
}

class _CalcDistanceState extends State<CalcDistanceWidget> {
